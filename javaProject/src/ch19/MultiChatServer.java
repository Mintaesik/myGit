...
class ServerScreen extends JFrame{
	...
	public ServerScreen() {
		...
		add(label, BorderLayout.NORTH); //기본이니까 보더레이아웃
		setVisible(true);
	}
}
...
public class MultiChatServer {
	...
	class ServerReceiver extends Thread{//내부클래스  여러명의 이용자를 상대하기 위해 스레드 상속
		Socket socket;
		DataInputStream in;
