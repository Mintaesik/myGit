...
public class EventEx2 extends JFrame{
	...
	public EventEx2() {
		...
		//버튼 클릭시 이벤트 기능 추가
		button1.addActionListener(new MyColorAction(this, Color.red)); //this(JFrame타입)는 EventEx2 자신의 객체를 가리킴
		button2.addActionListener(new MyColorAction(this, Color.green));//데이터타입으로는 JFrame타입이다. (JFrame을 상속받았기 때문에)
		...
		setSize(450, 300);
		setVisible(true);
		setDefaultCloseOperation(DISPOSE_ON_CLOSE); //현재창만 닫게 해줌
